...
This expands to the bigger picture of the [approachability of a project](http://blog.mozilla.com/dolske/2011/09/06/community-participation/) by the community, whether [open](http://cheater.posterous.com/automating-e2fsck) or [closed](http://notch.tumblr.com/post/9896830082/you-know-whats-fun) source. I find that the Mozilla team is very approachable and that it's their biggest forte. I think the health of an open-source project can be directly ascertained with this: try to make a patch for it. Mozilla passes with flying colours.

This is one of the things I hadn't seen an author I respect very much, Spolsky, write about. Granted, he's not an open-source proponent, but I think he can also redeem something practical for himself from this lesson. Joel, your developers [are](http://www.joelonsoftware.com/items/2011/05/26.html) your [users](http://http://www.joelonsoftware.com/articles/BuildingCommunitieswithSo.html), too. Treat them as such and your team is healthier.

Back to Mozilla. Contrast with FogBugz:
...
So your developers are your users. A free, open-source software has also got the benefit of the [converse](http://en.wikipedia.org/wiki/Contraposition) — their users are their developers. It brings the fact that the user can change the software much more to their liking; unless you make [warded-off](http://en.wikipedia.org/wiki/Application_programming_interface) [playgrounds](http://en.wikipedia.org/wiki/Plug-in_%28computing%29) you cannot have that in a closed-source application, although it [can](http://en.wikipedia.org/wiki/Virtual_Studio_Technology) be [very prolific](http://www.kvraudio.com/get.php?mode=results&st=adv&soft%5B%5D=i&soft%5B%5D=e&soft%5B%5D=h&soft%5B%5D=d&soft%5B%5D=w&type%5B%5D=0&f%5B%5D=0&f%5B%5D=au&f%5B%5D=dx&f%5B%5D=ladspa&f%5B%5D=rtas&f%5B%5D=vst&linux=1&osx=1&win=1&free=1&com=1&un=1&sf=0&receptor=&de=0&sort=3&rpp=100). What openness takes away is your ability to sell software for money, but [other minor things still seem to work](http://www.ecademy.com/node.php?id=164554).

The developers I have quoted above would undoubtedly be competent enough to fix the problems they are having in a world where what we know now as FogBugz were open-source. However, in such an open-source world we might not have reached the state of what FogBugz is right now at all. This is the problem; there are open-source things out there that do what fogBugz does and they don't do it as well. So as far as you can get a lot of bonuses for going full-on free, only money buys you [food](http://www.fogcreek.com/fogbugz/); the worst thing is that I don't know of any way that can work for a small developer who wants to make his software completely open, and yet make money with it. Releasing source code without unit tests, APIs, and documentation does not count. You are left with things like [SaaS](http://www.gnu.org/philosophy/who-does-that-server-really-serve.html); until GNU and the FOSS community can come up with a business model for me I will not be able to make my software completely free. This might need [changes](http://chomsky.info/articles/20110824.htm) in how the whole society [works](http://en.wikipedia.org/wiki/Ubuntu_%28philosophy%29), but you know overdoing this [can](http://en.wikipedia.org/wiki/Vladimir_Lenin) sometimes [lead](http://en.wikipedia.org/wiki/Vyacheslav_Molotov) to [bad](http://en.wikipedia.org/wiki/Joseph_Stalin) things.

On the other hand, a two-tier model where can work too: do your work closed-source but make components behind it open-source. It makes use of the idea of software being a public good, much like, say, the road infrastructure used by transport companies. They contribute (money) to the roads, even though the roads are used by everyone. This works to some extent; once you start being *technically* able to open-source more and more you stop being *commercially* able to do it; if a company doesn't pay you for your work you don't want to release it for free so that they can get it. I am currently sitting on a couple (out of many, many) quite respectably sized projects from customers who didn't pay the whole sum of money they should have; I know they would be very useful tools for anyone using the technologies they are written for working with; I'm not sure what to do with them.
...
The open-source process ensures the quality of things that come out of it by forcing improvement. If something starts being steered in the right direction, *just [fork](http://www.drizzle.org/) it*. If someone wants to steal your software — they can't, it's ensured by law. This puts the software as a virtual, ideal element poised above the current bearer of the torch; the person developing my software in 100 years from now can be replaced just as I will be one day when I choose not to do what the community wants to see anymore.
...
The GNU GPL allows me to release my software and ensure that its future iterations stay free; it lets me make sure that *what time I invest will benefit people forever*. What Mozilla needs is to apply the open-source process to its business practices. I think, if the "community interface" of Firefox is to be improved in any way, Mozilla should come up with a legal framework — maybe license-based, but maybe something completely different — that will *ensure* the project stays open to the community in the way it is now; in the same way that the Free Software Foundation *forces* its software to stay open. Mozilla is right now at a very good position to benchmark other projects against it and it is the best time to make such a decision. This could also mean that Mozilla would bring itself into a position where, if it fails, it could get replaced; that is the nature of freedom of software and — in this proposal — freedom of business practices. This is a bitter pill to swallow, but on the other hand you can see what's happening with Firefox: even though it's free, Mozilla is still by far the community's favourite; the community would never give them up because Mozilla are so good at it. If this happened, it would mean *free, open-source business*. If Mozilla can improve, then in my opinion this is the way.
</markdown>
