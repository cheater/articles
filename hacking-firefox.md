...
The GNU GPL allows me to release my software and ensure that its future iterations stay free; it lets me make sure that *what time I invest will benefit people forever*. What Mozilla needs is to apply the open-source process to its business practices. I think, if the "community interface" of Firefox is to be improved in any way, Mozilla should come up with a legal framework — maybe license-based, but maybe something completely different — that will *ensure* the project stays open to the community as it is now; analogously to how the Free Software Foundation *forces* its software to stay open. Mozilla is doing really well right now and it is the best time to make a move which would solidify that. This could also mean that Mozilla would bring itself into a position where, if it fails, it could get replaced; that is the nature of freedom of software and — in this proposal — freedom of business practices. This is a bitter pill to swallow, but on the other hand you can see what's happening with Firefox: even though it's free, Mozilla is still by far the community's favourite; the community would never give them up because Mozilla are so good at making browsers. It could be similar with the more deeper business practices behind Mozilla. If this happened, it would mean *free, open-source business*. If Mozilla can improve, then in my opinion this is the way.
</markdown>
